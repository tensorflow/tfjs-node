...
#define EXPORT_INT_PROPERTY(v) AssignIntProperty(env, exports, #v, v)
  ...
  // TFJS OpAttr Type extensions
  EXPORT_INT_PROPERTY(TFJS_ATTR_STRING_LIST);
  EXPORT_INT_PROPERTY(TFJS_ATTR_INT_LIST);
  EXPORT_INT_PROPERTY(TFJS_ATTR_FLOAT_LIST);
  EXPORT_INT_PROPERTY(TFJS_ATTR_BOOL_LIST);
  EXPORT_INT_PROPERTY(TFJS_ATTR_TYPE_LIST);
