...
const CPU_DARWIN = 'cpu-darwin-x86_64-1.13.0.tar.gz';
const CPU_LINUX = 'cpu-linux-x86_64-1.13.0.tar.gz';
const GPU_LINUX = 'gpu-linux-x86_64-1.13.0.tar.gz';
const CPU_WINDOWS = 'cpu-windows-x86_64-1.13.0.zip';
const GPU_WINDOWS = 'gpu-windows-x86_64-1.13.0.zip';
